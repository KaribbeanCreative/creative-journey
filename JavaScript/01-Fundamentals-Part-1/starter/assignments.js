...
const lessFiftyMillionsPeople = true;

if (speaksEnglish && !isAnIsland && lessFiftyMillionsPeople) {
   console.log(`Welcome Sarah 🏠!`)
} else (
   console.log(`😔 sorry Sarah we don't have all your criteria`);
)*/
...
const countryPopulation = 383559;

countryPopulation > 33000000 ? console.log(`Portugal's population is above average`) : console.log(`Portugal's population is below average`);